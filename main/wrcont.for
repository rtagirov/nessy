...
c         STOP 'OPMS7'
c         ENDIF
      CALL       DECSTAR_M (MODHEAD,FM,RSTAR,VDOP,RMAX,LDUMMY1,LDUMMY2,
     $                              LBKG,XLBKG1,XLBKG2,
     $                    LDUMMY3,MAXATOM,NATOM,ABXYZ,KODAT,IDAT,LBLANK,
     $                              ATMEAN)
...
!     $ 'Optical Depth',10x,'LambdaOperDiag')
     ...
     $    ALPHA,SEXPO,AGAUNT,0,NDUMMY,DUMMY2,WAVARR,SIGARR,
