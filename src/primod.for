      ...
      SUBROUTINE PRIMOD(ND,RADIUS,RSTAR,AINCRIT,ENTOT,T,VELO,GRADI,NP,
...
!     PRINTOUT OF THE DEPTH-DEPENDENT MODEL SPECIFICATIONS
      ...
      CHARACTER MODHEAD*104, AINCRIT(ND)*8
...
C      Print *,l,'Tauross(l)=', tauross(l)	
	IF (TAUROSS(L).LE.0.d0) THEN
      ...
      ENDIF
c    2 PRINT 3,L,RL1,RL2,AINCRIT(L),VELO(L),GRADI(L),DENS,T(L),ALTAU
