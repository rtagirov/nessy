      ...
      contains
      SUBROUTINE OPAROSS_M (OPARL,EN,TL,RNEL,ENTOTL,RSTAR,NDIM,N,
...
CMH   CALL COOP_M
     ...
     $                                                       THOMSON_,
     $      IWARN_,MAINPRO_,MAINLEV_,NOM,NDIM,N,LEVEL,NCHARG,WEIGHT,
     $       ELEVEL,EION,EINST,ALPHA,SEXPO,AGAUNT,0,NDUMMY0,DUMMY2,
     $       WAVARR,SIGARR,LBKG,XLBKG1,XLBKG2,NFDIM)
