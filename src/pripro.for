...
!      write(*, '(/,10X,A,11X,F11.3,A,F10.3,A,F10.3)'),
      write(*, '(/,10X,A,11X,E15.7,A,E15.7,A,E15.7)'),
     $     'ABSOLUTE LINE EMISSION (SOLAR LUM.): ', ABLINE, 
     $     ', EMISSION: ',                          ABLIEM, 
     $     ', ABSORPTION: ',                        ABLIAB

!   12 FORMAT (/,10X,'ABSOLUTE LINE EMISSION (SOLAR LUM.):',11X,F11.3,
!     $',  EMISSION:',F10.3,',  ABSORPTION:',F10.3 )
!   12 FORMAT (/,10X,A,11X,F11.3,A,F10.3,A,F10.3)
