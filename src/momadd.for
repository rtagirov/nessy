...
!      SUBROUTINE MOMADD(JP,LMAX,ND,NP,Z,RADIUS,P,W0,W1,W2,W3,WBMHO,WBMNO,WBMHI,WBMNI)
      SUBROUTINE MOMADD(JP, LMAX, ND, NP, Z, RADIUS, P, W0)

!     AT GIVEN IMPACT-PARAMETER INDEX JP, THIS SUBROUTINE CALCULATES THE
!     WEIGHTS FOR THE ANGLE INTEGRATION OF THE 0. TO 3. MOMENTS
!     THE WEIGHTS W0 AND W2 ARE CALCULATED FOR THE ORIGINAL DEPTH POINTS
!     THE WEIGHTS W1 AND W3 ARE CALCULATED FOR INTERMESH POINTS
!     SPECIAL WEIGHTS WBMH AND WBMN ARE CALCULATED FOR THE OUTER BOUNDARY
