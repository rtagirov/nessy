      module MOD_WRITRADC
      contains
      subroutine writradc (xjcarr,xjc,eddarr,eddi,emflux,totin,totout,
     $                     HTOT,GTOT,XTOT,ETOT,wcharm,nd,nf,MODHEAD,
     $			   JOBNUM)
...
! 		added wcharm operator to writradc (micha)
