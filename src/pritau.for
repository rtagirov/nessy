...
C**********  MODULNAME: PRITAU    ******* 06/08/87  20.14.53.******   135 KARTEN
     ...
     $                  POPNUM,NDIM,N,EN,LEVEL,NCHARG,WEIGHT,ELEVEL,
     $                  EION,EINST,ALPHA,SEXPO,AGAUNT,NOM,NF,XLAMBDA,
     $                  FWEIGHT,TAUTHOM,TAUROSS,WAVARR,SIGARR,NFDIM)
C***********************************************************************
...
C***********************************************************************
	...
	DIMENSION WAVARR(NDIM,NFDIM),SIGARR(NDIM,NFDIM)
      ...
      character*8,dimension(NDIM) :: AGAUNT
...
CMH      CALL OPAROSS (OPARL,EN,TL,RNEL,ENTOTL,RSTAR,NDIM,N,
C     $                   LEVEL,NCHARG,WEIGHT,ELEVEL,EION,EINST,
C     $                   ALPHA,SEXPO,AGAUNT,NF,XLAMBDA,FWEIGHT,NOM)
      CALL OPAROSS_M (OPARL,EN,TL,RNEL,ENTOTL,RSTAR,NDIM,N,
