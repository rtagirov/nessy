      ...
      SUBROUTINE DECSTAR_M (MODHEAD,FM,RSTAR,VDOP,RMAX,TTABLE,FAL,
     $                       LBKG,XLBKG1,XLBKG2,
     $                    TPLOT,MAXATOM,NATOM,ABXYZ,KODAT,IDAT,LBLANK,
     $                       ATMEAN)
C***********************************************************************
...
C***  COMMON /COMLTE/ TRANSFERS THE START OPTION FOR THE RADIATION FIELD
C***  TO SUBR. JSTART
      COMMON /COMLTE/ LTE
      LOGICAL LTE
C***  COMMON / COMPLOT / TRANSFERS THE MAXIMUM OF THE Y-AXIS TO SUBR. PLOTT
      COMMON / COMPLOT / YMAX
      DIMENSION ABXYZ(MAXATOM),KODAT(MAXATOM)
