  ...
  100 CONTINUE
      ...
      CALL RM_FILE('wall_time.etlray', '-vf')
      CALL RM_FILE('wall_time.cmfset', '-vf')
      CALL RM_FILE('wall_time.como',   '-vf')
      CALL RM_FILE('wall_time.coma',   '-vf')
      CALL RM_FILE('wall_time.coop',   '-vf')
      ...
      CALL RM_FILE('cpu_time.etlray',  '-vf')
      CALL RM_FILE('cpu_time.cmfset',  '-vf')
      CALL RM_FILE('cpu_time.como',    '-vf')
      CALL RM_FILE('cpu_time.coma',    '-vf')
      CALL RM_FILE('cpu_time.coop',    '-vf')
